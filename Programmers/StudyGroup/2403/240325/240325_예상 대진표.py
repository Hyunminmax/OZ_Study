...
# 몇 번째 라운드에서 만나는지 궁금해졌습니다. 게임 참가자 수 N, 참가자 번호 A, 경쟁자 번호 B가 함수 
# solution의 매개변수로 주어질 때, 처음 라운드에서 A번을 가진 참가자는 경쟁자로 생각하는 
...
# 1st try 난 도대체 니가 뭘 하고 있는지 모르겠다..
# def solution(n,a,b):
#     answer = 0
#     win1 = a
#     win2 = b
...
#         if tempLen1 == tempLen2 and tempLen1 != 0:
#             print('n:', n)
#             print('tempLen1:', tempLen1)
#             answer = (n - tempLen1) // 2
